  ...
  return (
    <div className="w3-animate-opacity">
      <div className="story-cover-image">
        <div className="story mx-auto">
          <h1>Story</h1>
          <p>Even dandies have origins.</p>
        </div>
      </div>
      <div className="the-story mx-auto">
        <h3>Chef. Chemist. Teacher. Business.</h3>
        <div className="story-content mx-auto text-monospace text-justify">
          <p>
